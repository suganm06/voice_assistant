...
while True:
    ...
    if 'time' in call:
        ...
        say("closing microsoft word boss")
        ...
        say("closing discord boss")
        subprocess.call(["taskkill","/F","/IM","Discord.exe"]) 
            
    elif "open files" in call:
        say("opening files boss")
        files=r"C:\Users\123.DESKTOP-74G99SN\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\System Tools\File Explorer"
        os.startfile(files)  
